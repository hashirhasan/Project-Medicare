...
<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="yoga-srch-btn">
            ...
            <input type="text" class="search-area"  placeholder="Doctors / Disease Name" >
    ...
    <!-- <nav> -->
        ...
        <div class="container">
            ...
            <div class="doc-pic"><img src="doc2.jpg"></div>
            ...
            <a class="use-btn" type="button" href="#popup2">Address</a>
