...
{ 
  ...
  $query="INSERT INTO users(username,user_role,user_firstname,user_lastname,user_email) "; 
  $query .="VALUES('$username','$user_role','$user_firstname','$user_lastname','$user_email')";
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <h2><label for="e-mail" >E-mail</label></h1><br>
       <input class="form" type="text" name="user_email">  
    </div><br><br>
